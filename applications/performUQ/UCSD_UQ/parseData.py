...
# filepath
#dakotajson_filepath = Path("C:/Users/Joel_2/Google Drive/Research/SIMCenter/Example1/integrationTo_quoFEM/Mukesh Maitreya/codeToSend/dakota.json")

# open file to parse
#with open(dakotajson_filepath,'r') as file_object:
#    string_to_parse = file_object.read()

#%% read dakota.json

with open('dakota.json','r') as file_object:
    string_to_parse = file_object.read()
