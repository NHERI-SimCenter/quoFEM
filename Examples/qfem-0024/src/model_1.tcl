...
# define elements:
# columns
element elasticBeamColumn 1 1 3 $Ac $E  [expr 2.*$k*(pow($h,3.))/48./$E] $TransfTag; #story stiffness k = 48*E*Icolumn/h^3
element elasticBeamColumn 2 3 5 $Ac $E  [expr 2.*$k*(pow($h,3.))/48./$E] $TransfTag;
element elasticBeamColumn 3 2 4 $Ac $E  [expr 2.*$k*(pow($h,3.))/48./$E] $TransfTag;
element elasticBeamColumn 4 4 6 $Ac $E  [expr 2.*$k*(pow($h,3.))/48./$E] $TransfTag;
# beams
