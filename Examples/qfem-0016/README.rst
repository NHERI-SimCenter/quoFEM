...
| **Surrogate model training time**: 59.3 min. (the number of simulation model runs: 293)
| **Analysis time**: 13.3 min. (the number of surrogate model evaluations: 1200)
...
| **Analysis time**: 71.1 min. (the number of simulation model evaluations: 1200)